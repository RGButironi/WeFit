<template>
  <div class="about">
    ...
    <p class="column has-text-weight-medium is-three-fifths is-offset-one-fifth">For many half the battle of getting in some exercise each day is finding a plan to follow.
      ...
      <p class="column has-text-weight-semibold is-half is-offset-one-quarter">Leverage the power of spontaneity to your benefit; new and exciting routines are at your fingertips with WeFit!</p>
  </div>
  </div>
</template>
